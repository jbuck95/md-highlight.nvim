-- ~/.config/nvim/lua/plugins/md-highlight.lua

return {
  -- Dummy Plugin Entry für Lazy
  {
    "nvim-lua/plenary.nvim", -- Dependency die sowieso da ist
    config = function()
      -- Unser Plugin Code direkt hier
      local M = {}
      ...
      M.setup({
        ...
        colors = {
          ...
          pywal_color_index = {
            bg = 3,  -- color3 (meist gelb/orange)
            fg = 0,  -- color0 (meist dunkel)
          },
          -- Beispiel für custom colors (auskommentiert):
          -- custom = {
          --   bg = "#ff6b6b",
          --   fg = "#ffffff",
          -- }
